...
namespace AntambaJ_ORM.Controllers
{
    public class EstudiantesController : Controller
    {
        private readonly SQLServerContext _context;

        public EstudiantesController(SQLServerContext context)
        {
            _context = context;
        }
        ...
        {
            var sQLServerContext = _context.Estudiante.Include(e => e.Carrera);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BannerID,Nombre,FechaNacimiento,TieneBeca,CarreraId")] Estudiante estudiante)
        {
